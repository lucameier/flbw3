...
def transform_data(file_buffer):
    ...
    abwesenheitsarten = {
        ...
        "1125": ("Auszeit pro rata", 1), "1140": ("Ind. bez. Urlaub IBU", 1), "1150": ("Selbstlernzeit", 1), "2000": ("Arbeitszeit", 1), "2001": ("Leistung", 1),
        "2002": ("BBD", 1), "2003": ("BBD Überzeit 1", 1), "2004": ("BBD Nachtdienst 3", 1), "2050": ("Reisezeit", 1), "2060": ("Reisezeit als Uez", 1),
        "2070": ("Piketteinsatz", 1), "2080": ("Piketteinsatz (Infra)", 1), "2090": ("Kasernierung Überzeit", 1), "2100": ("Pause AZG auswärts", 1),
        "2110": ("Pause/Nachtzu/ArbOrt", 1), "2120": ("Pause Heimatort", 1), "2121": ("Pause auswärts", 1), "2130": ("Ausw. Pause Nacht", 1),
        "2145": ("Pause Fussballfan-Zug", 1), "2201": ("Schichtlage ArG", 1), "2202": ("Schichtlage AZG", 1), "2210": ("Nebenarbeitszeit", 1),
        "2220": ("Dif. Mindestarbeitszeit", 1), "2230": ("Dif. Urspr.Arbeitsschicht", 1), "2235": ("Kurs ganztägig", 1), "2240": ("Aufenthalt Paris", 1),
        "2250": ("Leistungen im Ausland", 1), "2260": ("Betriebliche Anlässe", 1), "2265": ("Teammeeting", 1), "2270": ("Arbeitsunterbrechung", 1),
        "2271": ("Pause bezahlt", 1), "2280": ("Ausfallschicht", 1), "2285": ("Ruheschicht", 1), "2286": ("CT+ Cargo", 1), "2290": ("ReiseZ Per. Prüfung", 1),
        "2291": ("PrüfZ Per. Prüfung", 1), "2295": ("Komp. KSND1", 1), "2296": ("Komp. KSND2", 1), "8710": ("Weiterbildungsurlaub", 1),
